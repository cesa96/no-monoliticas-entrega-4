...
import json
from propiedades.modulos.clientes.aplicacion.servicios import ServicioReserva
from propiedades.modulos.clientes.aplicacion.dto import ReservaDTO
from propiedades.seedwork.dominio.excepciones import ExcepcionDominio

from flask import redirect, render_template, request, session, url_for
from flask import Response
from propiedades.modulos.clientes.aplicacion.mapeadores import MapeadorReservaDTOJson
from propiedades.modulos.clientes.aplicacion.comandos.crear_reserva import CrearReserva
from propiedades.modulos.clientes.aplicacion.queries.obtener_reserva import ObtenerReserva
