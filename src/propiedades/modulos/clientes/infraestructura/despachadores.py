...
from propiedades.modulos.clientes.infraestructura.schema.v1.eventos import EventoReservaCreada, ReservaCreadaPayload
from propiedades.modulos.clientes.infraestructura.schema.v1.comandos import ComandoCrearReserva, ComandoCrearReservaPayload
