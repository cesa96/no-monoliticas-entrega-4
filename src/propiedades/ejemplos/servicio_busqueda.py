from propiedades.modulos.clientes.dominio.objetos_valor import Odo, ParametroBusca, Segmento, Leg, CodigoIATA, Itinerario
from propiedades.modulos.clientes.dominio.entidades import Proveedor,Aeropuerto
